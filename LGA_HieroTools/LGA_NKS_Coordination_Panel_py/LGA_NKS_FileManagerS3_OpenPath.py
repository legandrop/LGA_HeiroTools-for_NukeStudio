...
def setup_debug_logging(script_name="FileManagerS3_OpenPath"):
...
debug_logger = setup_debug_logging(script_name="FileManagerS3_OpenPath")
...
def build_filemanagers3_cmd(shot_path):
    try:
...
def main():
    """Función principal que abre FileManagerS3 con la ruta del shot seleccionado"""
    ...
    try:
        ...
        if file_path:
            ...
            # Ejecutar FileManagerS3 con --path
            cmd = build_filemanagers3_cmd(shot_path)
            if not cmd:
                return
            ...
            try:
                ...
                debug_print("FileManagerS3 abierto correctamente")
