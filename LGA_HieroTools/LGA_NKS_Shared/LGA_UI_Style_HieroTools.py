...
____________________________________________________________________
  ...
  LGA_UI_Style_HieroTools v1.25 | Lega

  Punto UNICO de ajuste del look de las ventanas de HieroTools. Todo lo
  ...
  Uso:
      ...
      from LGA_NKS_Shared.LGA_UI_Style_HieroTools import Style, colorize_path, emphasis
  ...
  v1.20: Se adopta el cuerpo v1.20 de las copias del ToolPack, que
         estaban adelante: temas (theme(), seis paletas), fuentes del
         pack (Inter y JetBrains Mono en fonts/, load_fonts(),
         apply_ui_font(), semibold_*()), tokens nuevos y derivados.
         El detalle v1.07-v1.19 vive en el historial de las copias
         del ToolPack; el cuerpo vuelve a ser identico salvo los
         renombres de modulo y adapter.
  v1.06: El checkbox deshabilitado se distingue del habilitado, y
         Style.WINDOW tambien lo lleva: era la hoja de casi todas
         las ventanas que quedaban con el checkbox del host.
  v1.05: El checkbox se dibuja con el indicador de las apps Qt de LGA
         en vez del nativo, que cambia con el tema del host.
  v1.04: Metric.BUTTON_HEIGHT, para que el boton marcado y el
         secundario midan lo mismo en una fila de acciones.
  v1.03: OK_BG, WARNING_BG y ERROR_BG, para el fondo de una pastilla
         de estado con texto encima.
  v1.02: Style.FORM pinta tambien los QSpinBox. Las flechitas NO se
         tocan: estilarlas sin redefinir ::up-arrow deja el boton
         gris y sin el triangulo, o sea sin senal de que se clickea.
  v1.01: Color.ENTITY, para destacar el nombre de una task o de un
         nodo sin colgarse del color de la paleta de paths.
  v1.00: Copia del modulo de estilo de los ToolPacks. Es codigo
         IDENTICO a proposito: los cuatro repos son independientes y
         un usuario puede tener instalado uno solo, asi que no pueden
         importarse entre si. Si se cambia un color aca, se cambia en
         los cuatro.
____________________________________________________________________
"""
...
THEMES = (
    {
        ...
        "label": "Pack",
        "desc": (
            "Lo que hay hoy en LGA_UI_Style_HieroTools: gris 212121 y el violeta de la marca."
        ),
        "colors": {
            "WINDOW": "#212121",
            "SURFACE": "#272727",
